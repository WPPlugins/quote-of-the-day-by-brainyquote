...
class BrainyQuote_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo __( '<script type="text/javascript" src="https://www.brainyquote.com/link/' . $qtype. '.js?iwp=1"></script><small><i><a href="https://www.brainyquote.com/quotes_of_the_day.html?utm_source=wordpress_onsite&utm_medium=feeds&utm_campaign=' . $qtype . '" target="_blank">more Quotes</a></i></small>', 'text_domain' );
